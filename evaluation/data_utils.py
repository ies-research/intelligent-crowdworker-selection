...
DATA_PATH = "/home/marek/Projects/GitHub/intelligent-crowdworker-selection/data"
TABULAR_DATA_SETS = [
    "letter",
]
RGB_IMAGE_DATA_SETS = ["cifar10"]
...
def load_data(
    ...
    A : numpy.ndarray, shape (n_annotators, n_annot_features)
        ...
        encoded vectors.
    """
    data_set_list = TABULAR_DATA_SETS + RGB_IMAGE_DATA_SETS
